    ...
    <aside className="absolute inset-y-0 left-0 z-30 w-60 border-r border-slate-700/60 bg-slate-950/90" aria-label="My decks">
      ...
      <div className="flex items-center justify-between gap-2 pb-2">
        ...
        <button
          type="button"
          onClick={onCreateNew}
          className="flex h-6 shrink-0 items-center gap-1 px-1 text-[11px] font-semibold text-blue-300 transition-colors hover:text-blue-100"
        >
      ...
      <div className="border-t border-slate-700/50">
        {groupedDecks.map((group) => {
          ...
          return (
            <section key={group.key} className="border-b border-slate-700/50 py-1.5">
              <button
                type="button"
                  ...
                  {group.decks.map((deck) => {
                    ...
                    return (
                      <button
                        ...
                        className={`relative w-full py-1.5 pl-5 pr-2 text-left transition-colors ${
                          selected
