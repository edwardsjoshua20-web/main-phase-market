...
export default function MobileCommunityDecks() {
  ...
  return (
    <div className="min-h-screen bg-white flex flex-col pb-16">
      ...
      <MobileBottomNav cartCount={cart.itemCount} wishlistCount={wishlist.count} onCartClick={() => setCartOpen(true)} onWishlistClick={() => setWishlistOpen(true)} currentPage="CommunityDecks" />
