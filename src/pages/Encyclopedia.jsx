              ...
              <div className="relative flex min-h-full w-full items-center justify-between gap-4 px-5 py-5 md:px-6">
                <div className="flex min-h-20 min-w-0 items-center justify-start">
                  <img
                    ...
                    alt={`${game.label} logo`}
                    loading="lazy"
                    className={`h-auto object-contain drop-shadow-[0_4px_18px_rgba(0,0,0,0.75)] ${game.id === 'magic' ? 'w-[170px] max-h-11 brightness-0 invert opacity-95' : `w-auto ${game.logoClassName}`}`}
                  />
                </div>
